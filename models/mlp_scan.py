...
class CNN_DistributedScanningMLP():
    ...
    def init_weights(self, weights):
        ...
        w1, w2, w3 = weights
        self.conv1.conv1d_stride1.W = w1[:48, :2].transpose().reshape(2,2,24).transpose(0,2,1)
        self.conv2.conv1d_stride1.W = w2[:4, :8].transpose().reshape(8,2,2).transpose(0,2,1)
        self.conv3.conv1d_stride1.W = w3.transpose().reshape(4,2,8).transpose(0,2,1)
